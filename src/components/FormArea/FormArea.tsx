    ...
    return (
        <div id='form-area'>
            <div className='text-center rounded-md py-8'>
                <h2 className='text-2xl text-black font-bold'>এখানে কিনতে নিবন্ধন করুন</h2>
                <p className='text-sm font-bold text-black'>পরে প্রচার শেষ হওয়ার কথা</p>
                ...
                <h2 className='text-sm text-black font-bold mx-4'>অর্ডার করার জন্য সমস্ত তথ্য পূরণ করুন, যদি আপনার কোন প্রশ্ন থাকে, আমাদের ফ্যানপেজের মাধ্যমে আমাদের সাথে যোগাযোগ করুন!!</h2>
